defmodule ContactApp.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule ContactAppWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: ContactApp.PromEx
  ...
  use PromEx, otp_app: :contact_app
  ...
  def plugins do
    [
      ...
      {Plugins.Phoenix, endpoint: ContactAppWeb.Endpoint, router: ContactAppWeb.Router, metric_prefix: [:prom_ex, :phoenix]},
      {PromEx.Plugins.Ecto, metric_prefix: [:prom_ex, :ecto], otp_app: :contact_app, repos: [ContactApp.Repo]},
      # Plugins.Oban,
      # Plugins.PhoenixLiveView,
      # Plugins.Absinthe,
      # Plugins.Broadway,

      {Plugins.PlugCowboy, routers: [ContactAppWeb.Router], metric_prefix: [:prom_ex, :plug_cowboy]}

      # Add your own PromEx metrics plugins
      # ContactApp.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:contact_app, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
